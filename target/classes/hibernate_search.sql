-- MySQL dump 10.10
--
-- Host: localhost    Database: hibernate_search
-- ------------------------------------------------------
...
INSERT INTO `author` VALUES (1,'潘爱民'),(2,'徐宝文'),(3,'李志'),(4,'谢孟军'),(5,'蔡斌'),(6,'陈湘萍'),(7,'佘建伟'),(8,'赵凯'),(9,'李刚'),(10,'淘宝前端团队'),(11,'武欣'),(12,'高洛峰'),(13,'刘铭'),(14,'朱舸'),(15,'周庆成'),(16,'邓强'),(17,'武海峰'),(18,'陈晓亮'),(19,'王寒'),(20,'周雪彬'),(21,'屈光辉'),(22,'周庆成');
UNLOCK TABLES;
...
CREATE TABLE `book_author` (
  ...
  KEY `FK1A9A0FA19890A7DF` (`author_id`),
  KEY `FK1A9A0FA119C4805F` (`book_id`),
  CONSTRAINT `FK1A9A0FA119C4805F` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`),
  CONSTRAINT `FK1A9A0FA19890A7DF` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `book_author` VALUES (1,1),(2,2),(2,3),(3,4),(4,5),(4,6),(5,7),(5,8),(6,9),(7,10),(8,11),(9,12),(10,13),(10,14),(11,15),(11,16),(11,17),(11,18),(12,19),(12,20),(12,21),(13,22);
UNLOCK TABLES;
